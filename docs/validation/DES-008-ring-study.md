...
## Revision and layout interface

This report was rerun on 2026-09-25 to align with both active A/C1 layouts in
PR13 at `f57e26e83b826867c2720edcd702e808fe946854`: target inner radius **710 mm**,
first disk **1430 mm**. The [all-disk compatibility report](DES-008-layout-compatibility.md)
checks five/six rings at all six disk positions and records mounting-space limits.
The [initial 700 mm / 1320 mm evidence](https://github.com/asalzburger/nodd/blob/68932692fc61bb25d21e55a915a12eb929b2b316/docs/validation/DES-008-ring-study.md)
is retained in ordinary Git history, including its original JSON and figures.
The numerical change is a user-requested interface correction, not a new approval.

## Geometric result

A **six-ring, 96×96 mm² continuous-strip sandwich** is a useful working geometry:
404 module pairs, one sensor-outline type, no missed pairs on either sampled grid
...
with 360 pairs and about 4.2% less silicon-outline area, but six sensor types and
...
is 710–1100 mm, the reference disk z=1430 mm and vertices z=−150,0,+150 mm.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Wedge, continuous strips | 6 | 6 | 360 | 720 | 3.218 | 0 sampled | 0 |
| Square 96×96, continuous strips | 6 | 1 | 404 | 808 | 3.358 | 0 sampled | 0 |
| Narrow 48×96, continuous strips | 6 | 1 | 860 | 1720 | 3.574 | 0 sampled | 0 |
| Square 96×96, two nominal 48 mm rows | 6 | 1 | 404 | 808 | 3.358 | 0.3119% | 0 |
| Wide 96×48, 48 mm strips | 12 | 1 | 790 | 1580 | 3.283 | 2.5548% | 0 |
| Wide 96×48, added-ring control | 14 | 1 | 910 | 1820 | 3.782 | 0.6022% | 924 |
| Square 96×96, five-ring control | 5 | 1 | 338 | 676 | 2.809 | 1.0914% | 0 |
...
normal-projection samples**, yet lose 1.09% and 2.55% of pair coverage once the
actual sensor planes and vertex rays are used. Testing only the projected union
would incorrectly shortlist both. In the wide twelve-ring case, 1.04% of the
...
Its worst area loss is 0.3017% on the 250×720 grid and 0.3119% on the 500×1440
grid. The 100×360 scan gives 0.2857% at the nominal settings: narrow seams
...
| 4.0 | 3.7 | −0.3 | 1.7 | 0 | 0 |
| 5.0 | 4.7 | +0.7 | 0.7 | 0 | 0 |
| 6.6 | 6.3 | +2.3 | −0.9 | 618 | 0 |
| 10.0 | 9.7 | +5.7 | −4.3 | 618 | 0 |
...
Reusing PR21's 3 mm centre-level spacing gives **1044** intersecting trial bodies.
Increasing the radial mounting/service allowance from 5 to 30 mm at nominal
spacing gives **341**. The nominal body stack is 7.3 mm, and the four-level
...
in the vertex fixture is **4.30 mm**. It must be propagated between planes.

## Occupied envelope and support handoff

The nominal square's occupied radial range is **687.55–1123.68 mm**. Wedges span
686.03–1124.04 mm; narrow rectangles 688.03–1122.33 mm. These fit the 1140 mm
...
below the proposed 710 mm long-strip target and the 700 mm short-strip outer edge. This is an explicit
...
study at the recorded revision and working-tree state. There is no random seed because no randomness
...
Fourteen geometry/measurement and layout-contract tests passed. They include independent full enumeration
